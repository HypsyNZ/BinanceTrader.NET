    ...
    internal class DummyTestOrder
    {
        private void TestOrder()
        {
            Task.Run(async () =>
            {
                ...
                //BinanceStreamOrderUpdate data0 = new BinanceStreamOrderUpdate() { Symbol = "DOGEUSDT", OrderId = 22, Price = 1, Quantity = 100.0M, QuantityFilled = 0, Event = "executionReport", Status = OrderStatus.New, CreateTime = DateTime.UtcNow, Side = OrderSide.Buy, Type = OrderType.Limit, BuyerIsMaker = false };
                ...
                BinanceStreamOrderUpdate data12 = new BinanceStreamOrderUpdate() { Symbol = "DOGEUSDT", OrderId = 24, Price = 1, Quantity = 100.0M, QuantityFilled = 100.0M, Event = "executionReport", Status = OrderStatus.Filled, CreateTime = DateTime.UtcNow, Side = OrderSide.Buy, Type = OrderType.Market, BuyerIsMaker = false };
                BinanceStreamOrderUpdate data14 = new BinanceStreamOrderUpdate() { Symbol = "DOGEUSDT", OrderId = 25, Price = 1, Quantity = 100.0M, QuantityFilled = 100.0M, Event = "executionReport", Status = OrderStatus.Filled, CreateTime = DateTime.UtcNow, Side = OrderSide.Buy, Type = OrderType.Market, BuyerIsMaker = false };
